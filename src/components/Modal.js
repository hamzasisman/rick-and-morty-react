    ...
    return (
        <>
            <div ref={ref} id="modal"
                className="transition-transform duration-300 fixed hidden z-50 justify-center w-full top-[100px] rounded-[10px] px-2 sm:px-8 py-6 space-y-5 drop-shadow-lg">
                <div id={props.character.id} className="relative group">
